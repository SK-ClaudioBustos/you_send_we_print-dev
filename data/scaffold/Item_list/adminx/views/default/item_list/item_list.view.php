...
<view key="body">
	<form method="post" enctype="multipart/form-data" action="<?=$app->go($app->module_key, false, '/save')?>" class="form form-horizontal item_list-form">
		<div class="row">
			<div class="col-md-12">
				...
				<div class="portlet">
					...
					<div class="portlet-body">
						<div class="form-body">
							<?=$tpl->get_view('_input/text', array('field' => 'title', 'label' => 'item_list:title', 'val' => $object->get_title(),
									'required' => true, 'error' => $object->is_missing('title')))?>
							<?=$tpl->get_view('_input/text', array('field' => 'item_list_key', 'label' => 'item_list:item_list_key', 'val' => $object->get_item_list_key(),
									'required' => true, 'error' => $object->is_missing('item_list_key')))?>
							<?=$tpl->get_view('_input/text', array('field' => 'calc_by', 'label' => 'item_list:calc_by', 'val' => $object->get_calc_by(),
