	...
	$(function() {
		var options = {
				colModel: [
						...
						{ name: 'title', index: 'title', label: lng_text('disclaimer:title'), width: 200, formatter: render_link },
						{ name: 'featured', index: 'featured', label: lng_text('disclaimer:featured'), width: 90, align: 'right', sorttype: 'int' },
		   		],
				sortname: 'title',
			   	sortorder: 'ASC'
