...
<view key="body">
	<form method="post" enctype="multipart/form-data" action="<?=$app->go($app->module_key, false, '/save')?>" class="form form-horizontal product_list-form">
		<div class="row">
			<div class="col-md-12">
				...
				<div class="portlet">
					...
					<div class="portlet-body">
						<div class="form-body">
							<?=$tpl->get_view('_input/select', array('field' => 'product_id', 'label' => 'product_list:product_id', 'val' => $object->get_product_id(),
									'required' => true, 'error' => $object->is_missing('product_id'),
									'options' => $products, 'none_val' => '', 'none_text' => ''))?>
							<?=$tpl->get_view('_input/text', array('field' => 'product_key', 'label' => 'product_list:product_key', 'val' => $object->get_product_key(),
									'required' => true, 'error' => $object->is_missing('product_key')))?>
							<?=$tpl->get_view('_input/text', array('field' => 'item_list_key', 'label' => 'product_list:item_list_key', 'val' => $object->get_item_list_key(),
