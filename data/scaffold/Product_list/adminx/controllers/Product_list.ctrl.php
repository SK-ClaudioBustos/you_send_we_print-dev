 ...
 *
 * -------------------------------------------------------
 * CLASSNAME:        Product_listCtrl
 * GENERATION DATE:  2020-04-17
 * -------------------------------------------------------
  *
 */

class Product_listCtrl extends CustomCtrl {
	protected $mod = 'Product_list';
	protected $class = 'Product_list';
	...
	protected function run_export($args = false) {
		...
		$header = array(
				$this->lng->text('product_list:product_id'),
				$this->lng->text('product_list:product_key'),
				$this->lng->text('product_list:item_list_key'),
			);
