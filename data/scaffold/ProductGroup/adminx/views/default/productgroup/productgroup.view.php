...
<view key="body">
	<form method="post" enctype="multipart/form-data" action="<?=$app->go($app->module_key, false, '/save')?>" class="form form-horizontal productgroup-form">
		<div class="row">
			<div class="col-md-12">
				...
				<div class="portlet">
					...
					<div class="portlet-body">
						<div class="form-body">
							<?=$tpl->get_view('_input/select', array('field' => 'product_id', 'label' => 'productgroup:product_id', 'val' => $object->get_product_id(),
									'required' => true, 'error' => $object->is_missing('product_id'),
									'options' => $products, 'none_val' => '', 'none_text' => ''))?>
							<?=$tpl->get_view('_input/select', array('field' => 'group_id', 'label' => 'productgroup:group_id', 'val' => $object->get_group_id(),
									'required' => true, 'error' => $object->is_missing('group_id'),
									'options' => $groups, 'none_val' => '', 'none_text' => ''))?>
						</div>
