...
//echo var_dump($_SESSION[$tmp_var]); exit;
	...
	protected function run_ajax_rows($objects = false) {
		$data = array(
				...
				'sort_field'	=> $this->get_input('sort_field', 'id'),
				'sort_order'	=> $this->get_input('sort_order', 'desc'),
				'filter'		=> $this->get_input('filter', '', true),
				'limit'			=> $this->get_input('limit', '50'), // TODO: limit should be taken from grid_setup
			);
