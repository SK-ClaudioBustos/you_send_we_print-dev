...
//		),	
	...
	// Sherton $cfg['ilibs_dir'] 	   = array('/projects/iBrowser/pictures/');						   	// image library path with slashes; absolute to root directory - please make sure that the directories have write permissions
	$cfg['ilibs_dir'] 	   = array('/data/site/pictures/');						   	// image library path with slashes; absolute to root directory - please make sure that the directories have write permissions
