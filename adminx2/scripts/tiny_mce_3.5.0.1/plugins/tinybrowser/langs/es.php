...
*/
		...
		define("TB_MSGDELETE", "%s archivos fueron borrados.");
		define("TB_MSGRENAME", "%s archivos han cambiado de nombre.");
		define("TB_MSGMOVE", "%s archivos fueron movidos.");
		...
		define("TB_EDDENIED", "Necesitas permisos de edición o borrado para ver esta página.");
 		define("TB_FODENIED", "Necesita permisos de mantenimiento de carpeta para ver esta página.");
?>