...
$tinybrowser['obfuscate'] = 'oIOahfoNadshfdaksjhf!!!111';
...
$tinybrowser['path']['image'] = '/data/files/images/'; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
$tinybrowser['path']['media'] = '/data/files/media/'; // Media files location
$tinybrowser['path']['file']  = '/data/files/files/'; // Other files location
