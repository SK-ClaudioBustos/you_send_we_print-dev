		...
		<div class="page-content-wrapper">
			<div class="page-content">
				...
				<div class="page-bar page-bar-top hidden-xs search-container">
					<?= $tpl->get_view('_input/search_gral') ?>
				</div>
				...
				<?php if ($app->warning && !isset($show_warning)) { ?>
					<div class="warning">
						<?= $app->warning ?>
					</div>
				<?php } ?>
				...
				<div class="clearfix">
					<span id="total_top"></span>
					<h1 class="page-title"><?= $title ?></h1>
				</div>

				<div class="content">
					<div class="page-bar">
						<?= $tpl->get_view('_elements/breadcrumb', array('breadcrumb' => $breadcrumb)) ?><?= $page_toolbar ?>
					</div>
					<div class="row">
						<div class="col-sm-12">
