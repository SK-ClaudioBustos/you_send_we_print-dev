...
<div class="form-group">
    ...
    <div class="col-xs-12 col-sm-4">
        ...
        <div class="col-xs-12 col-sm-4">
          <span class="help" id='acc_quantity1' style='display:none; font-size:11px; color:#6c9e2b'>Confirm required Quantity</span>
        </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-xs-12 col-sm-4">
          <span class="help" id='acc_quantity2' style='display:none; font-size:12px; color:#6c9e2b'>Confirm required Quantity</span>
        </div>
</div>
