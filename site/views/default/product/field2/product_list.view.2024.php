...
if (isset($em) && $em) {
    ...
    if (trim($info_quantity) != "") { if($label_quantity != "" and strstr(strtolower($label_quantity),"pieces") ) $_SESSION["isbulk"] = "isbulk"; //aviso al shipping que es bulk?>
...
<div class="info info-list-<?=$item_list_key?>">
    <div class="info-title"><?=$lng->text('product:' . $item_list_key)?></div>
