...
if (isset($em) && $em) {
    ...
    if(trim($label_quantity) !="")
        echo "<script>document.addEventListener('DOMContentLoaded', function(event) {document.getElementById('label_".$item_list_key."').innerHTML='".$label_quantity.'&nbsp;<a href="#" class="info" data-target="quantity-'.$item_list_key.'"><span class="badge badge-green">i</span></a>'." '; if(document.getElementById('info_".$item_list_key."')) document.getElementById('info_".$item_list_key."').textContent='".$info_quantity."' });</script>";
