    ...
    var handleGoTop = function () {
        ...
        if (navigator.userAgent.match(/iPhone|iPad|iPod/i)) {  // ios supported
            ...
            $(window).scroll(function() {
                if ($(this).scrollTop() > offset) {
                    $('.scroll-to-top').fadeIn(duration);
                    $('.logo-default').attr("src","/data/site/logo-new.png");
                    $('.logo-default').css("margin-top","6px");
                    $('.page-header.navbar.navbar-fixed-top').css("padding-top","0px");
                    $('.page-header.navbar.navbar-fixed-top').css("height","54px");
                    $('.page-header.navbar .hor-menu').css("height","54px");
                  
                    
           
                } else {
                    $('.scroll-to-top').fadeOut(duration);
                    $('.logo-default').attr("src","/data/site/logo-new-m.png");
                    $('.logo-default').css("margin-top","");
                    if (App.getViewPort().width > 480){
                    $('.page-header.navbar.navbar-fixed-top').css("padding-top","14px");
                    $('.page-header.navbar.navbar-fixed-top').css("height","74px");
                    }
                    $('.page-header.navbar .hor-menu').css("height","");
                }
            });
        }
