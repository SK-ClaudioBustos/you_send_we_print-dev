...
//$PHPTHUMB_CONFIG['document_root'] = $this->cfg->path->supplemvc . '/lib/phpThumb';
//echo $PHPTHUMB_CONFIG['document_root']; exit;
...
//bajo el límite de tamaño bajo limite de días en cache a 20 días. hoy 22/10/2022
//$PHPTHUMB_CONFIG['cache_maxsize'] = null;           // never delete cached thumbnails based on byte size of cache directory
$PHPTHUMB_CONFIG['cache_maxsize'] = 1024 * 1024 * 1000; // delete least-recently-accessed cached thumbnails when more than [10MB] of cached files are present (value is maximum bytesize of all cached files)

//$PHPTHUMB_CONFIG['cache_maxfiles'] = null;          // never delete cached thumbnails based on number of cached files
$PHPTHUMB_CONFIG['cache_maxfiles'] = 800;             // delete least-recently-accessed cached thumbnails when more than [200] cached files are present (value is maximum number of cached files to keep)
...
$PHPTHUMB_CONFIG['high_security_password']   = ''; // 'm0AQF.s2!9Aq&1,X?a';     // required if 'high_security_enabled' is true, and must be at complex (uppercase, lowercase, numbers, punctuation, etc -- punctuation is strongest, lowercase is weakest; see PasswordStrength() in phpThumb.php). You can use a password generator like http://silisoftware.com/tools/password-random.php to generate a strong password
