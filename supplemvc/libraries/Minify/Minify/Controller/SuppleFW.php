 ...
 */
class Minify_Controller_SuppleFW extends Minify_Controller_Base {
    ...
    public function setupSources($options) {
        ...
        $pi = isset($options['type']) ? $options['type'] : false;
        
        if (false === $pi || ! isset($groups[$pi])) {
            // no type or not a valid group
            $this->log("Missing type or no group set for \"$pi\"");
            return $options;
        }
        $sources = array();
