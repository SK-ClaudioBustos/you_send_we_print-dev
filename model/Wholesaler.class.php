...
class Wholesaler extends Base {

	// status ws_pending | ws_approved | ws_rejected / TODO: create enum

	// Protected Vars

	protected $dbClass = 'WholesalerDb';
	...
	protected $language = '';
	protected $status = 'ws_pending'; // ws_pending/ws_approved/ws_rejected
	protected $discount = '';

	protected $wholesaler_number = '';
	protected $wholesaler_image = array();
	protected $certificate_image = array();
	protected $taxable = ''; // tx_yes, tx_no_florida, tx_no_other, tx_no_country
	...
	public function get_wholesaler_number() { return $this->wholesaler_number; }
	public function get_wholesaler_image() { return $this->wholesaler_image; }
	public function get_certificate_image() { return $this->certificate_image; }
	public function get_taxable() { return $this->taxable; }
	...
	public function set_wholesaler_number($val) { $this->wholesaler_number = $val; }
	public function set_wholesaler_image($val) { $this->wholesaler_image = $val; }
	public function set_certificate_image($val) { $this->certificate_image = $val; }
	public function set_taxable($val) { $this->taxable = $val; }
	...
	public function address_count() {
		$user_address = new UserAddress();
		$user_address->set_user_id($this->get_user_id());
		return $user_address->list_count();
	}
	...
	protected function load() {
		if ($row = $this->rs->fetchObject()) {
			...
			$this->set_wholesaler_number($row->wholesaler_number);
			$this->set_wholesaler_image(json_decode($row->wholesaler_image, true));		//
			$this->set_certificate_image(json_decode($row->certificate_image, true));	//
			$this->set_taxable($row->taxable);
